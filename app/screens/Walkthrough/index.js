...
export default function Walkthrough({navigation}) {
   ...
   * @author UnlimitedWebworks <unlimitedwebworks.com>
   * @date 2024-02-12
   */
  const authentication = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      dispatch(AuthActions.authentication(true)); // Dispatch action to set authentication status
      navigation.navigate('Main'); // Redirect to main screen upon authentication
